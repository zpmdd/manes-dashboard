...
export function LayerPanel({ layers, setLayers, quality, setQuality, detail, onClose, extraLayers = [] }) {
  const rows = [...extraLayers, ['roadmap', '离线道路底图', '本地地图图片 · 最大 10 级，放大后细节有限'], ['roads', '道路网络', detail ? '高速、国道及主要干线' : '全国主要道路 · 概化数据'], ['beacons', '监测光柱', '演示节点，暂未关联业务数据'], ['arcs', '区域连线', '示意关联，不表示车辆轨迹'], ['heat', '态势热力', '演示数据的空间分布'], ['labels', '区域名称', '全国显示各省名称，下钻显示区域与道路标签']];
