...
export function ConfigPanel({ config, onApply, onClose }) {
  const [draft, setDraft] = useState(() => ({ title: config.title, mapTitle: config.mapTitle, navLabels: [...config.navLabels], showClock: config.showClock, font: config.font || DEFAULT_FONT.id }));
